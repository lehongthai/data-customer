                    ...
                    <div class="card">
                        ...
                        {{ csrf_field() }}
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control show-tick" name="cate_id">
                                        ...
                                        <option value="{{ $cate->id }}" 
                                            @if(old('cate_id') == $cate->id) selected  @endif 
                                        >{{ $cate->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="quantity" value="{{ old('quantity') }}" class="form-control" placeholder="Product Quantity" />
                                    </div>
                            ...
                            <div class="demo-radio-button">
                                <input name="status" value="1" type="radio" id="radio_7" class="radio-col-red" @if(old('status') == 1) checked @endif />
                                <label for="radio_7">RED</label>
                                <input name="status" value="2" type="radio" id="radio_8" class="radio-col-pink" @if(old('status') == 2) checked @endif />
                                <label for="radio_8">PINK</label>
                                <input name="status" value="3" type="radio" id="radio_9" class="radio-col-purple" @if(old('status') == 3) checked @endif />
                                <label for="radio_9">PURPLE</label>
                                <input name="status" value="4" type="radio" id="radio_10" class="radio-col-deep-purple" @if(old('status') == 4) checked @endif />
                                <label for="radio_10">DEEP PURPLE</label>
                                <input name="status" value="5" type="radio" id="radio_11" class="radio-col-indigo" @if(old('status') == 5) checked @endif />
                                <label for="radio_11">INDIGO</label>
                                <input name="status" value="6" type="radio" id="radio_12" class="radio-col-blue" @if(old('status') == 6) checked @endif />
                                <label for="radio_12">BLUE</label>
                                <input name="status" value="7" type="radio" id="radio_13" class="radio-col-light-blue" @if(old('status') == 7) checked @endif />
                                <label for="radio_13">LIGHT BLUE</label>
                                <input name="status" value="8" type="radio" id="radio_14" class="radio-col-cyan" @if(old('status') == 8) checked @endif />
                                <label for="radio_14">CYAN</label>
                                <input name="status" value="9" type="radio" id="radio_15" class="radio-col-teal" @if(old('status') == 9) checked @endif />
                            </div>
                            </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <label>Product Note</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="4" name="note" class="form-control no-resize" placeholder="Please type what you want...">{{ old('note') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
