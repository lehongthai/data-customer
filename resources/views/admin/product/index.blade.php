                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <a class="btn btn-primary m-t-15 waves-effect" href="{{ route('user.create') }}">CREATE</a>
                            </ul>
                        </div>
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @foreach($listProduct as $product)
                                    <tr>
                                        ...
                                        <td>
                                           <?php
                                                $date=date_create($product->last_modify);
                                                echo date_format($date, 'H Y-m-d');
                                            ?>     
                                        </td>
                                        <td>
                                            <?php
                                        ...
                                        <td>
                                            <li class="dropdown pull-right" style="list-style: none">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    ...
                                                    <li>
                                                        <a onclick="return confirm_delete('Bạn chắc chắn xóa !')"  href="{{ route('product.destroy', $product->id) }}">Delete</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </td>
