                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                       ...
                       <ul class="dropdown-menu pull-right">
                            ...
                            <li><a href="{{ route('user.edit') }}"><i class="material-icons">update</i>Update</a></li>
                            <li role="seperator" class="divider"></li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ route('product.index') }}" class="menu-toggle">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ route('config.index') }}" class="menu-toggle">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ route('contact.show') }}" class="menu-toggle">
